...
import { GridRecord } from '../models/gridRecord.model';


@Injectable()
export class GridRecordService implements RecordControlService {
  public recordType: string = 'GridRecords';
  public loadUrl: string = 'getGridRecords';
  public saveUrl: string = 'UpdateGridRecords';
  public addUrl: string = 'AddGridRecord';
  public deleteUrl: string = 'DeleteGridRecord';


  public filterRecord: FilterRecord;
  public recordStructure: Array<any> = [
    { headerName: 'Number',        type: 'number',    prec: 8,   field: 'recordNumber',    width: 60,  pinned: 'left', align: 'left',   reg: 1, dev: 1},
    { headerName: 'Name',          type: 'string',    prec: 100, field: 'name',            width: 80,  pinned: false,  align: 'left',   reg: 1, dev: 1},
    { headerName: 'Description',   type: 'string',    prec: 100, field: 'description',     width: 100,  pinned: false,  align: 'left',   reg: 1, dev: 1},
    { headerName: 'Address',       type: 'string',    prec: 100, field: 'address',         width: 150,  pinned: false,  align: 'left',   reg: 1, dev: 1},
    { headerName: 'Role',          type: 'string',    prec: 60,  field: 'role',            width: 80,   pinned: false,  align: 'left',   reg: 1, dev: 1},
  ];
  ...
  public addRecord(url = this.addUrl): void {
    ...
    let newGrid = new GridRecord({});

    this.apiService.addRecord(url, newGrid).toPromise().then(
      success => {
        let record = newGrid;
